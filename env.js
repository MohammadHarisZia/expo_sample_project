 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.sample.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.sample'; // ios bundle id
const PACKAGE = 'com.sample'; // android package name
const NAME = 'sampleApp'; // app name
const EXPO_ACCOUNT_OWNER = 'sample'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'sample_mobile'; // app scheme
